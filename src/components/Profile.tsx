      ...
      <div className="container">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-10 md:mb-14">
            <p className="font-body text-sm md:text-base text-foreground leading-[1.6] italic whitespace-pre-line">
              {t('profile.vision.quote')}
            </p>
            <p className="font-body text-sm md:text-base text-foreground leading-[1.6] mt-4 whitespace-pre-line">

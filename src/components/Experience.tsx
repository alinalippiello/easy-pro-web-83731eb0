...
const projectsData: ProjectData[] = [
  {
    ...
    year: 'In corso',
    collaborators: `**Progetto Alina Lippiello**

Cliente: Gebäude- und Wohnungsbaugesellschaft Wernigerode mbH

Team di progetto: Leonardo Zuccaro Marchi, Alice Covatta, Alina Lippiello, Piero Medici

Ruolo (Alina Lippiello): Coordinamento e sviluppo del progetto, progettazione tipologica, definizione del sistema di facciata e dei dettagli architettonici. Supervisione tecnica e interfaccia diretta con l'architetto locale.

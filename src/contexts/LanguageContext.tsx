...
const translations: Record<Language, Record<string, string>> = {
  it: {
    ...
    'profile.profile.p1': "Sono un'architetta e concept designer che lavora al confine tra progetto, ricerca e direzione artistica. Il mio percorso si è sviluppato attraverso concorsi internazionali, progetti residenziali e una riflessione critica sull'architettura contemporanea, con un interesse costante per il rapporto tra spazio, paesaggio e struttura urbana.",
    'profile.profile.p2': "La mia formazione integra pratica progettuale e ricerca teorica. Dopo gli studi in architettura, ho approfondito il pensiero dell'architettura radicale e delle avanguardie del Novecento, sviluppando una riflessione sul concetto di architettura come paesaggio e come campo. In questo contesto si colloca la ricerca di dottorato in Progettazione Architettonica e Urbana presso il Politecnico di Milano, dedicata alla dissoluzione del binomio figura-sfondo e alle relazioni tra architettura e paesaggio. Il percorso di dottorato non è stato completato, ma la ricerca costituisce ancora oggi la base teorica del mio lavoro.",
    'profile.profile.p3': "La tesi di laurea, dedicata al waterfront di Spalato, affronta la riconfigurazione dell'area portuale come nodo intermodale, indagando la continuità tra città e mare e il rapporto tra spazio costruito e spazio aperto. Questo tema della continuità si ritrova, a diverse scale, in tutta la mia pratica progettuale.",
    'profile.profile.p4': "Il mio lavoro si sviluppa attraverso concorsi e collaborazioni internazionali, tra cui Europan e Shinkenchiku, che hanno rappresentato un terreno di sperimentazione sul tema dell'abitare collettivo e delle infrastrutture come dispositivi capaci di connettere sistemi urbani frammentati. In questo quadro, opero tra concept design, direzione artistica e consulenza strategica, accompagnando progetti complessi nella costruzione di una visione coerente, dalla fase iniziale fino allo sviluppo.",
    'profile.profile.p5': "Per me l'architettura si configura come un organismo stratificato: un campo di relazioni in cui spazio e tempo, memoria e trasformazione, città e paesaggio si intrecciano in un flusso continuo. Ogni progetto diventa un frammento narrativo di una ricerca sulla metamorfosi del territorio e sulle sue possibili configurazioni future.",
...
Il cuore del progetto è un sistema diagonale di spazi pubblici e rampe che non solo collega i diversi livelli dell'edificio ma crea anche un nuovo polo di aggregazione sociale per la comunità studentesca.`,
  ...
  en: {
    ...
    'profile.profile.p2': "My training integrates design practice and theoretical research. After studying architecture, I deepened the thinking of radical architecture and twentieth-century avant-gardes, developing a reflection on the concept of architecture as landscape and as field. Within this context lies my doctoral research in Architectural and Urban Design at the Politecnico di Milano, dedicated to the dissolution of the figure-ground binomial and to the relationships between architecture and landscape. The doctoral path was not completed, but the research still constitutes the theoretical foundation of my work.",
    'profile.profile.p3': "My degree thesis, dedicated to the waterfront of Split, addresses the reconfiguration of the port area as an intermodal node, investigating the continuity between city and sea and the relationship between built and open space. This theme of continuity recurs, at different scales, throughout my design practice.",
    'profile.profile.p4': "My work develops through international competitions and collaborations, including Europan and Shinkenchiku, which have been a ground of experimentation on the theme of collective dwelling and infrastructures as devices capable of connecting fragmented urban systems. Within this framework, I operate between concept design, art direction and strategic consulting, accompanying complex projects in building a coherent vision, from the initial phase through to development.",
    'profile.profile.p5': "For me, architecture takes shape as a stratified organism: a field of relationships in which space and time, memory and transformation, city and landscape intertwine in a continuous flow. Each project becomes a narrative fragment of a research on the metamorphosis of the territory and its possible future configurations.",
...
The heart of the project is a diagonal system of public spaces and ramps that not only connects the different levels of the building but also creates a new hub of social gathering for the student community.`,
  ...
  es: {
    ...
    'profile.profile.p2': "Mi formación integra práctica proyectual e investigación teórica. Tras los estudios en arquitectura, profundicé el pensamiento de la arquitectura radical y las vanguardias del siglo XX, desarrollando una reflexión sobre el concepto de arquitectura como paisaje y como campo. En este contexto se sitúa la investigación de doctorado en Proyectación Arquitectónica y Urbana en el Politecnico di Milano, dedicada a la disolución del binomio figura-fondo y a las relaciones entre arquitectura y paisaje. El recorrido de doctorado no fue completado, pero la investigación constituye todavía hoy la base teórica de mi trabajo.",
    'profile.profile.p3': "La tesis de grado, dedicada al frente marítimo de Split, aborda la reconfiguración del área portuaria como nodo intermodal, indagando la continuidad entre ciudad y mar y la relación entre espacio construido y espacio abierto. Este tema de la continuidad se reencuentra, a diferentes escalas, en toda mi práctica proyectual.",
    'profile.profile.p4': "Mi trabajo se desarrolla a través de concursos y colaboraciones internacionales, entre ellos Europan y Shinkenchiku, que han representado un terreno de experimentación sobre el tema del habitar colectivo y de las infraestructuras como dispositivos capaces de conectar sistemas urbanos fragmentados. En este marco, opero entre concept design, dirección artística y consultoría estratégica, acompañando proyectos complejos en la construcción de una visión coherente, desde la fase inicial hasta el desarrollo.",
    'profile.profile.p5': "Para mí la arquitectura se configura como un organismo estratificado: un campo de relaciones en el que espacio y tiempo, memoria y transformación, ciudad y paisaje se entrelazan en un flujo continuo. Cada proyecto se convierte en un fragmento narrativo de una investigación sobre la metamorfosis del territorio y sus posibles configuraciones futuras.",

...
const translations: Record<Language, Record<string, string>> = {
  it: {
    ...
    'blog.save': 'Salva',
    'blog.cancel': 'Annulla',
    'blog.publish': 'Pubblica',
    'blog.unpublish': 'Rimuovi pubblicazione',
    'blog.confirmDelete': 'Eliminare definitivamente questo articolo?',
    'blog.category': 'Categoria',
    'blog.slug': 'Slug (URL)',
    'blog.cover': 'Immagine di copertina',
    'blog.uploadCover': 'Carica immagine',
    'blog.titleField': 'Titolo',
    'blog.excerpt': 'Estratto',
    'blog.content': 'Contenuto',
    'blog.lang.it': 'Italiano',
    'blog.lang.en': 'Inglese',
    'blog.lang.es': 'Spagnolo',
    'blog.cat.riflessione': 'Riflessione',
    'blog.cat.articolo': 'Articolo',
    'blog.cat.progetto': 'Progetto',
    'blog.cat.appunto': 'Appunto',
    ...
    // Strati — concept titles & phrases (default keys)
    'strati.concept.innestare.title': 'INNESTARE',
    'strati.concept.innestare.phrase': 'Abitare una condizione esistente senza cancellarne la memoria.',
    'strati.concept.piegare.title': 'PIEGARE',
    'strati.concept.piegare.phrase': 'Trasformare il paesaggio in spazio attraversabile.',
    'strati.concept.dissolvere.title': 'DISSOLVERE',
    'strati.concept.dissolvere.phrase': 'Superare il limite tra figura, infrastruttura e paesaggio.',
    'strati.concept.porosita.title': 'POROSITÀ',
    'strati.concept.porosita.phrase': 'Aprire il costruito a flussi ecologici, sociali e visivi.',
    'strati.concept.stratificare.title': 'STRATIFICARE',
    'strati.concept.stratificare.phrase': 'Far emergere il tempo attraverso materia e territorio.',
    'strati.concept.mat-building.title': 'MAT-BUILDING',
    'strati.concept.mat-building.phrase': 'Costruire continuità attraverso densità, ripetizione e relazione.',
    // Strati — tile alt texts
    'strati.alt.piega': 'Schema concettuale della piega — ricerca tipologica',
    'strati.alt.tessuto': 'Vista aerea del tessuto urbano',
    'strati.alt.materia': 'Modello fisico — studio della materia',
    'strati.alt.innesto': 'Disegno planimetrico — innesto urbano',
    'strati.alt.topografia': 'Pianta topografica del sito di progetto',
    'strati.alt.chiaroscuro': 'Studio chiaroscurale di volumi architettonici',
    'strati.alt.porto': 'Vista aerea area portuale — masterplan',
    'strati.alt.segno': 'Schizzo di progetto — segno fondativo',
    'strati.alt.waterfront': 'Render waterfront e fronte urbano',
    'strati.alt.quartiere': 'Modello di studio quartiere residenziale',
    'strati.alt.continuita': 'Modello volumetrico — studio di continuità',
    'strati.alt.facciata': 'Render — studio di facciata residenziale',
    'strati.alt.topografia2': 'Pianta topografica — variante di progetto',
    'strati.alt.nodo': 'Schema urbano — nodo infrastrutturale',
    'strati.alt.orizzonte': 'Render prospettico — orizzonte urbano',
...
Il cuore del progetto è un sistema diagonale di spazi pubblici e rampe che non solo collega i diversi livelli dell'edificio ma crea anche un nuovo polo di aggregazione sociale per la comunità studentesca.`,
  ...
  en: {
    ...
    'blog.confirmDelete': 'Permanently delete this article?',
    'blog.category': 'Category',
    'blog.slug': 'Slug (URL)',
    'blog.cover': 'Cover image',
    'blog.uploadCover': 'Upload image',
    'blog.titleField': 'Title',
    'blog.excerpt': 'Excerpt',
    'blog.content': 'Content',
    'blog.lang.it': 'Italian',
    'blog.lang.en': 'English',
    'blog.lang.es': 'Spanish',
    'blog.cat.riflessione': 'Reflection',
    'blog.cat.articolo': 'Article',
    'blog.cat.progetto': 'Project',
    'blog.cat.appunto': 'Note',
    ...
    'strati.next': 'Next',
    // Strati — concept titles & phrases
    'strati.concept.innestare.title': 'GRAFT',
    'strati.concept.innestare.phrase': 'Inhabiting an existing condition without erasing its memory.',
    'strati.concept.piegare.title': 'FOLD',
    'strati.concept.piegare.phrase': 'Transforming the landscape into traversable space.',
    'strati.concept.dissolvere.title': 'DISSOLVE',
    'strati.concept.dissolvere.phrase': 'Crossing the boundary between figure, infrastructure and landscape.',
    'strati.concept.porosita.title': 'POROSITY',
    'strati.concept.porosita.phrase': 'Opening the built fabric to ecological, social and visual flows.',
    'strati.concept.stratificare.title': 'STRATIFY',
    'strati.concept.stratificare.phrase': 'Letting time emerge through matter and territory.',
    'strati.concept.mat-building.title': 'MAT-BUILDING',
    'strati.concept.mat-building.phrase': 'Building continuity through density, repetition and relation.',
    // Strati — tile alt texts
    'strati.alt.piega': 'Conceptual diagram of the fold — typological research',
    'strati.alt.tessuto': 'Aerial view of the urban fabric',
    'strati.alt.materia': 'Physical model — study of matter',
    'strati.alt.innesto': 'Plan drawing — urban graft',
    'strati.alt.topografia': 'Topographic plan of the project site',
    'strati.alt.chiaroscuro': 'Chiaroscuro study of architectural volumes',
    'strati.alt.porto': 'Aerial view of the port area — masterplan',
    'strati.alt.segno': 'Project sketch — founding mark',
    'strati.alt.waterfront': 'Waterfront and urban front render',
    'strati.alt.quartiere': 'Study model of a residential neighborhood',
    'strati.alt.continuita': 'Volumetric model — continuity study',
    'strati.alt.facciata': 'Render — residential facade study',
    'strati.alt.topografia2': 'Topographic plan — project variant',
    'strati.alt.nodo': 'Urban diagram — infrastructural node',
    'strati.alt.orizzonte': 'Perspective render — urban horizon',
...
The heart of the project is a diagonal system of public spaces and ramps that not only connects the different levels of the building but also creates a new hub of social gathering for the student community.`,
  ...
  es: {
    ...
    'blog.confirmDelete': '¿Eliminar definitivamente este artículo?',
    'blog.category': 'Categoría',
    'blog.slug': 'Slug (URL)',
    'blog.cover': 'Imagen de portada',
    'blog.uploadCover': 'Subir imagen',
    'blog.titleField': 'Título',
    'blog.excerpt': 'Extracto',
    'blog.content': 'Contenido',
    'blog.lang.it': 'Italiano',
    'blog.lang.en': 'Inglés',
    'blog.lang.es': 'Español',
    'blog.cat.riflessione': 'Reflexión',
    'blog.cat.articolo': 'Artículo',
    'blog.cat.progetto': 'Proyecto',
    'blog.cat.appunto': 'Apunte',
    ...
    // Strati — títulos y frases de los conceptos
    'strati.concept.innestare.title': 'INJERTAR',
    'strati.concept.innestare.phrase': 'Habitar una condición existente sin borrar su memoria.',
    'strati.concept.piegare.title': 'PLEGAR',
    'strati.concept.piegare.phrase': 'Transformar el paisaje en espacio transitable.',
    'strati.concept.dissolvere.title': 'DISOLVER',
    'strati.concept.dissolvere.phrase': 'Superar el límite entre figura, infraestructura y paisaje.',
    'strati.concept.porosita.title': 'POROSIDAD',
    'strati.concept.porosita.phrase': 'Abrir lo construido a flujos ecológicos, sociales y visuales.',
    'strati.concept.stratificare.title': 'ESTRATIFICAR',
    'strati.concept.stratificare.phrase': 'Hacer emerger el tiempo a través de materia y territorio.',
    'strati.concept.mat-building.title': 'MAT-BUILDING',
    'strati.concept.mat-building.phrase': 'Construir continuidad a través de densidad, repetición y relación.',
    // Strati — textos alternativos de las imágenes
    'strati.alt.piega': 'Esquema conceptual del pliegue — investigación tipológica',
    'strati.alt.tessuto': 'Vista aérea del tejido urbano',
    'strati.alt.materia': 'Modelo físico — estudio de la materia',
    'strati.alt.innesto': 'Dibujo planimétrico — injerto urbano',
    'strati.alt.topografia': 'Planta topográfica del sitio del proyecto',
    'strati.alt.chiaroscuro': 'Estudio claroscuro de volúmenes arquitectónicos',
    'strati.alt.porto': 'Vista aérea del área portuaria — masterplan',
    'strati.alt.segno': 'Boceto de proyecto — signo fundacional',
    'strati.alt.waterfront': 'Render del waterfront y frente urbano',
    'strati.alt.quartiere': 'Modelo de estudio del barrio residencial',
    'strati.alt.continuita': 'Modelo volumétrico — estudio de continuidad',
    'strati.alt.facciata': 'Render — estudio de fachada residencial',
    'strati.alt.topografia2': 'Planta topográfica — variante de proyecto',
    'strati.alt.nodo': 'Esquema urbano — nodo infraestructural',
    'strati.alt.orizzonte': 'Render en perspectiva — horizonte urbano',

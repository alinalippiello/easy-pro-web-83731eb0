...
const translations: Record<Language, Record<string, string>> = {
  it: {
    ...
    'profile.profile.p1': "Sono un architetto e concept designer con esperienza nella progettazione architettonica, nella ricerca teorica e nella direzione artistica di processi complessi. Ho sviluppato il mio percorso tra concorsi internazionali, progetti residenziali e riflessione critica sull'architettura contemporanea, con un interesse particolare per il rapporto tra spazio, paesaggio e struttura urbana.",
    'profile.profile.p2': "La mia formazione integra pratica progettuale e ricerca critica. Dopo gli studi in architettura, ho approfondito il pensiero dell'architettura radicale e delle avanguardie del Novecento, sviluppando una riflessione sul concetto di architettura come paesaggio e come campo. La mia visione dello spazio è influenzata da una ricerca sul movimento e sulla percezione: lo spazio non come forma statica, ma come sequenza, ritmo e relazione tra corpo, struttura e territorio. Questo sguardo orienta il mio modo di concepire l'architettura come esperienza e come dispositivo dinamico.",
    'profile.profile.p3': "Il mio approccio si fonda su una visione radicale e al tempo stesso concreta: l'architettura come infrastruttura culturale e territoriale, capace di generare nuove forme di abitabilità e nuove narrazioni dello spazio.",
    'profile.bio.title': 'Bio',
    'profile.bio.heading': 'Alina Lippiello — Architetto, ricercatrice, designer',
    'profile.bio.p1': "L'architettura, per Alina Lippiello, si configura come un organismo stratificato: un campo di relazioni in cui spazio e tempo, memoria e trasformazione, città e paesaggio si intrecciano in un flusso continuo. Ogni progetto diventa un frammento narrativo di una ricerca sulla metamorfosi del territorio e sulle sue possibili configurazioni future.",
    'profile.bio.p2': "La tesi di laurea, dedicata al waterfront di Spalato, affronta la riconfigurazione dell'area portuale come nodo intermodale, indagando il rapporto tra città e mare e la continuità tra spazio costruito e spazio aperto.",
    'profile.bio.p3': "Successivamente intraprende il dottorato in Progettazione Architettonica e Urbana presso il Politecnico di Milano (XIX ciclo), con una ricerca sulla dissoluzione del binomio figura-sfondo e sulle relazioni tra architettura e paesaggio. In questo periodo partecipa a workshop e seminari internazionali sulla trasformazione urbana e infrastrutturale, confrontandosi con progetti come il terminal dell'aeroporto Charles de Gaulle a Parigi, lo stadio olimpico di New York, la stazione di Bergamo e la stazione di Bari.",
    'profile.bio.p4': "La ricerca confluisce nella tesi: «La rottura del binomio figura-sfondo: la città come edificio, l'architettura come paesaggio. Dalla corrente megastrutturalista alla landscape architecture.»",
    'profile.bio.p5': "Il percorso di dottorato non viene concluso. La ricerca rimane una base teorica fondamentale della sua pratica.",
    'profile.bio.p6': "Durante il dottorato svolge un periodo di ricerca presso NYIT — New York Institute of Technology, approfondendo le dinamiche della trasformazione metropolitana e il rapporto tra infrastrutture e paesaggio urbano.",
    'profile.bio.p7': "Le pubblicazioni, sviluppate nell'ambito del dottorato, includono contributi sulla trasformazione urbana e infrastrutturale, tra cui «New York – Milano: Disegno della città per la regione urbana» (2007), «Stazioni, un sipario urbano» (2006) e «Bari, studi per la metropoli» (2005).",
    'profile.bio.p8': "Il suo lavoro si sviluppa attraverso il confronto con contesti progettuali e concorsi internazionali, tra cui una menzione allo Shinkenchiku Residential Design Competition (2008), il secondo posto a Europan 11 e il progetto vincitore del Planetario di Matera. Nel 2019 partecipa al concorso per residenze «Wohnen am Illerpark» (Neu-Ulm), che segna l'avvio della collaborazione con Co-P-E.",
    'profile.bio.p9': "La sua pratica esplora le infrastrutture come sistemi capaci di generare continuità tra condizioni urbane frammentate, mettendo in relazione spazi separati attraverso connessioni spaziali. Le relazioni spaziali vengono intese come campi aperti, in cui i legami tra funzioni, tempi e usi si costruiscono attraverso il progetto.",
    'profile.bio.p10': "L'abitare collettivo diventa un campo di sperimentazione orientato a configurazioni spaziali capaci di evolvere insieme alle trasformazioni del contesto.",
    'profile.bio.p11': "La sua ricerca continua a interrogare il rapporto tra architettura e territorio come campo continuo, in cui il progetto non si limita a occupare lo spazio, ma lo riscrive e lo riconnette.",
    'profile.areas.title': 'Ambiti di intervento',
    'profile.areas.item1': 'Concept design per architettura e spazio urbano',
    'profile.areas.item2': 'Direzione artistica di progetti architettonici e urbani',
    'profile.areas.item3': 'Consulenza strategica per studi, sviluppatori e istituzioni',
    'profile.areas.item4': 'Ricerca e narrazione progettuale',
    'profile.areas.footer': "Lavoro in contesti internazionali, collaborando con team multidisciplinari e studi di architettura, mantenendo una pratica indipendente orientata alla qualità del pensiero progettuale.",
...
Il cuore del progetto è un sistema diagonale di spazi pubblici e rampe che non solo collega i diversi livelli dell'edificio ma crea anche un nuovo polo di aggregazione sociale per la comunità studentesca.`,
  ...
  en: {
    ...
    'profile.profile.p1': "I am an architect and concept designer with experience in architectural design, theoretical research and art direction of complex processes. I developed my path through international competitions, residential projects and critical reflection on contemporary architecture, with a particular interest in the relationship between space, landscape and urban structure.",
    'profile.profile.p2': "My training integrates design practice and critical research. After studying architecture, I deepened the thinking of radical architecture and twentieth-century avant-gardes, developing a reflection on the concept of architecture as landscape and as field. My vision of space is influenced by research on movement and perception: space not as static form, but as sequence, rhythm and relationship between body, structure and territory. This perspective guides my way of conceiving architecture as experience and as a dynamic device.",
    'profile.profile.p3': "My approach is founded on a radical yet concrete vision: architecture as cultural and territorial infrastructure, capable of generating new forms of habitability and new narratives of space.",
    'profile.bio.title': 'Bio',
    'profile.bio.heading': 'Alina Lippiello — Architect, researcher, designer',
    'profile.bio.p1': "Architecture, for Alina Lippiello, is a stratified organism: a field of relations in which space and time, memory and transformation, city and landscape intertwine in a continuous flow. Each project becomes a narrative fragment within a broader inquiry into the metamorphosis of territory and its possible future configurations.",
    'profile.bio.p2': "Her degree thesis, dedicated to the Split waterfront, addresses the reconfiguration of the port area as an intermodal node, investigating the relationship between city and sea and the continuity between built and open space.",
    'profile.bio.p3': "She later undertakes a PhD in Architectural and Urban Design at Politecnico di Milano (19th cycle), focusing on the dissolution of the figure–ground dichotomy and on the relationship between architecture and landscape. During this period, she participates in international workshops and seminars on urban and infrastructural transformation, engaging with projects such as the Charles de Gaulle Airport terminal in Paris, the New York Olympic Stadium, Bergamo railway station, and Bari railway station.",
    'profile.bio.p4': "The research culminates in the dissertation: «The Breakdown of the Figure–Ground Dichotomy: The City as Building, Architecture as Landscape. From Megastructuralism to Landscape Architecture.»",
    'profile.bio.p5': "The PhD was not completed. The research remains a fundamental theoretical foundation of her practice.",
    'profile.bio.p6': "During her PhD, she conducts a research period at NYIT — New York Institute of Technology, deepening metropolitan transformation processes and the relationship between infrastructure and urban landscape.",
    'profile.bio.p7': "Her publications, developed within the doctoral research, include contributions on urban and infrastructural transformation such as «New York – Milan: Designing the Urban Region» (2007), «Stations, an Urban Curtain» (2006), and «Bari, Studies for the Metropolis» (2005).",
    'profile.bio.p8': "Her work develops through engagement with design contexts and international competitions, including an honorable mention at the Shinkenchiku Residential Design Competition (2008), second prize at Europan 11, and the winning project for the Planetarium of Matera. In 2019, she participates in the residential competition «Wohnen am Illerpark» (Neu-Ulm), marking the beginning of her collaboration with Co-P-E.",
    'profile.bio.p9': "Her practice explores infrastructure as systems capable of generating continuity across fragmented urban conditions, establishing relations between separated spaces through spatial connections. Spatial relations are understood as open fields in which links between functions, times, and uses are constructed through design.",
    'profile.bio.p10': "Collective housing becomes a field of experimentation oriented toward spatial configurations capable of evolving with contextual transformation.",
    'profile.bio.p11': "Her research continues to question architecture and territory as a continuous field, where design does not merely occupy space but actively rewrites and reconnects it.",
    'profile.areas.title': 'Areas of expertise',
    'profile.areas.item1': 'Concept design for architecture and urban space',
    'profile.areas.item2': 'Art direction of architectural and urban projects',
    'profile.areas.item3': 'Strategic consulting for studios, developers and institutions',
    'profile.areas.item4': 'Research and design narrative',
    'profile.areas.footer': "I work in international contexts, collaborating with multidisciplinary teams and architecture studios, maintaining an independent practice oriented towards the quality of design thinking.",
...
The heart of the project is a diagonal system of public spaces and ramps that not only connects the different levels of the building but also creates a new hub of social gathering for the student community.`,
  ...
  es: {
    ...
    'profile.profile.p1': "Soy arquitecta y concept designer con experiencia en diseño arquitectónico, investigación teórica y dirección artística de procesos complejos. He desarrollado mi trayectoria entre concursos internacionales, proyectos residenciales y reflexión crítica sobre la arquitectura contemporánea, con un interés particular por la relación entre espacio, paisaje y estructura urbana.",
    'profile.profile.p2': "Mi formación integra práctica proyectual e investigación crítica. Tras los estudios en arquitectura, profundicé el pensamiento de la arquitectura radical y las vanguardias del siglo XX, desarrollando una reflexión sobre el concepto de arquitectura como paisaje y como campo. Mi visión del espacio está influenciada por una investigación sobre el movimiento y la percepción: el espacio no como forma estática, sino como secuencia, ritmo y relación entre cuerpo, estructura y territorio. Esta mirada orienta mi manera de concebir la arquitectura como experiencia y como dispositivo dinámico.",
    'profile.profile.p3': "Mi enfoque se funda en una visión radical y al mismo tiempo concreta: la arquitectura como infraestructura cultural y territorial, capaz de generar nuevas formas de habitabilidad y nuevas narrativas del espacio.",
    'profile.bio.title': 'Bio',
    'profile.bio.heading': 'Alina Lippiello — Arquitecta, investigadora, diseñadora',
    'profile.bio.p1': "La arquitectura, para Alina Lippiello, se configura como un organismo estratificado: un campo de relaciones en el que espacio y tiempo, memoria y transformación, ciudad y paisaje se entrelazan en un flujo continuo. Cada proyecto se convierte en un fragmento narrativo de una investigación sobre la metamorfosis del territorio y sus posibles configuraciones futuras.",
    'profile.bio.p2': "La tesis de licenciatura, dedicada al waterfront de Split, aborda la reconfiguración del área portuaria como nodo intermodal, indagando la relación entre ciudad y mar y la continuidad entre espacio construido y espacio abierto.",
    'profile.bio.p3': "Posteriormente emprende el doctorado en Proyectación Arquitectónica y Urbana en el Politecnico di Milano (XIX ciclo), con una investigación sobre la disolución del binomio figura-fondo y sobre las relaciones entre arquitectura y paisaje. En este periodo participa en talleres y seminarios internacionales sobre transformación urbana e infraestructural, confrontándose con proyectos como la terminal del aeropuerto Charles de Gaulle de París, el estadio olímpico de Nueva York, la estación de Bérgamo y la estación de Bari.",
    'profile.bio.p4': "La investigación confluye en la tesis: «La ruptura del binomio figura-fondo: la ciudad como edificio, la arquitectura como paisaje. De la corriente megaestructuralista a la landscape architecture.»",
    'profile.bio.p5': "El doctorado no se concluye. La investigación permanece como base teórica fundamental de su práctica.",
    'profile.bio.p6': "Durante el doctorado realiza un periodo de investigación en NYIT — New York Institute of Technology, profundizando las dinámicas de la transformación metropolitana y la relación entre infraestructuras y paisaje urbano.",
    'profile.bio.p7': "Las publicaciones, desarrolladas en el ámbito del doctorado, incluyen contribuciones sobre la transformación urbana e infraestructural, entre ellas «New York – Milano: Disegno della città per la regione urbana» (2007), «Stazioni, un sipario urbano» (2006) y «Bari, studi per la metropoli» (2005).",
    'profile.bio.p8': "Su trabajo se desarrolla a través de la confrontación con contextos proyectuales y concursos internacionales, entre ellos una mención en el Shinkenchiku Residential Design Competition (2008), el segundo premio en Europan 11 y el proyecto ganador del Planetario de Matera. En 2019 participa en el concurso residencial «Wohnen am Illerpark» (Neu-Ulm), que marca el inicio de la colaboración con Co-P-E.",
    'profile.bio.p9': "Su práctica explora las infraestructuras como sistemas capaces de generar continuidad entre condiciones urbanas fragmentadas, poniendo en relación espacios separados a través de conexiones espaciales. Las relaciones espaciales se entienden como campos abiertos, en los que los vínculos entre funciones, tiempos y usos se construyen a través del proyecto.",
    'profile.bio.p10': "El habitar colectivo se convierte en un campo de experimentación orientado a configuraciones espaciales capaces de evolucionar junto a las transformaciones del contexto.",
    'profile.bio.p11': "Su investigación continúa interrogando la relación entre arquitectura y territorio como campo continuo, en el que el proyecto no se limita a ocupar el espacio, sino que lo reescribe y lo reconecta.",
    'profile.areas.title': 'Ámbitos de intervención',
    'profile.areas.item1': 'Concept design para arquitectura y espacio urbano',
    'profile.areas.item2': 'Dirección artística de proyectos arquitectónicos y urbanos',
    'profile.areas.item3': 'Consultoría estratégica para estudios, promotores e instituciones',
    'profile.areas.item4': 'Investigación y narrativa proyectual',
    'profile.areas.footer': "Trabajo en contextos internacionales, colaborando con equipos multidisciplinares y estudios de arquitectura, manteniendo una práctica independiente orientada a la calidad del pensamiento proyectual.",
